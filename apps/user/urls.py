...
from apps.user.views import RegisterUser, Profile, DetailsProyect, DetailsCommunity, ProyectDelete, CommunityDelete
...
urlpatterns=[
	...
	#url(r'update/(?P<id>\d+)/$', UserUpdate, name="update"),
